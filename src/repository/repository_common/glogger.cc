...
class RepositoryAppendLogger : public aitheta2::IndexLogger {
 public:
  RepositoryAppendLogger() = default;

  ~RepositoryAppendLogger() {
    this->cleanup();
  }
...
INDEX_FACTORY_REGISTER_LOGGER(RepositoryAppendLogger);
